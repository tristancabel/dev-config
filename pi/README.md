...
- planner → clarification-heavy planning after exploration
...
- Dev path: use `planner → builder → reviewer`; planner grills for clarifications and drafts the approach, builder implements, reviewer audits.
...
- hard read-only isolation for conversation, scout, and planner
